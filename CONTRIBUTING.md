...
For more details on the architecture, see [docs/architecture.md](docs/architecture.md) and [docs/OromScript_Design_Specification.md](docs/OromScript_Design_Specification.md).